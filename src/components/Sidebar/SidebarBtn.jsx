...
const SidebarBtn = () => {
  ...
  return (
    <motion.div
      className="fixed right-5 z-40 md:right-20 xl:right-48"
      // drag
    ...
    >
      <motion.button
        ...
        className={` relative z-40 cursor-pointer overflow-hidden rounded-full border   bg-lightGray p-2  transition-all ease-in after:absolute after:-left-full after:top-0 after:z-[1] after:h-full after:w-full after:rounded-[50%] after:duration-300 hover:border hover:border-lightGray hover:text-white  hover:shadow-tealBlue hover:after:left-0 hover:after:bg-tealBlue  dark:bg-gray-900  hover:dark:border-gray-900 hover:dark:text-gray-900 hover:dark:shadow-lightBlue hover:after:dark:bg-lightBlue ${openSidebar ? "border-tealBlue bg-tealBlue text-lightGray dark:border-lightBlue dark:bg-lightBlue dark:text-gray-900" : "border-transparent text-tealBlue dark:text-lightBlue"}`}
      >
